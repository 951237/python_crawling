...
chromedriver = '/Users/mac/Documents/coding_python/python_crawling/chromedriver_mac'

# 다운로드 폴더 만들기
if not os.path.exists(dirs):    # 폴더확인후 없으면
    os.mkdir(dirs) #폴더 만들기
